...
def train(
    ...
    #                                 num_resets_per_eval))
    # For num_timesteps=100M, batch_size=256, unroll=20, num_minibatches=32 (typical of locomotion), num_evals=10
    # env_step_per_training_step = 163840
    # num_training_steps_per_epoch = 62
    ...
    # ENV_STATE has a dim corresponding to device!
    ...
    # TODO pmap_axis_name can be set to None
    ...
    def training_step(
        ...
        # JITTING HERE
        # Get all our data (replay buffer) for one policy update iteration
        ...
        # ONLY OUTPUTS ONCE DURING JIT AND NOT AFTERWARDS!!!!
        print(data.observation.shape)

        # JITTING HERE
        # Perform multiple steps of SGD on our replay buffer
        (optimizer_state, params, _), metrics = jax.lax.scan(
    ...
    def training_epoch(
        ...
        # JITTING HERE
        # multiple training iters (data collect + learn)
    ...
    # JITTING HEREE
    # Applies training epoch across devices so while old training_epoch takes say MxN data, new one takes KxMxN where K is num devices
    ...
    #### PUTS A LEADING DIM of #DEVICES on all pytree array leaves!!
    import ipdb
